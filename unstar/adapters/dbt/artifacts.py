...
def _load_with_parser(manifest_path: str, project_dir: str) -> Optional[DbtArtifacts]:  # pragma: no cover
    try:
    ...
    for node in manifest.nodes.values():
        ...
        models[name] = DbtModel(
            ...
            compiled_sql=getattr(node, "compiled_code", None) or getattr(node, "compiled_sql", None),
        )
